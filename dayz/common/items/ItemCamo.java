...
public class ItemCamo extends ItemArmor implements IArmorTextureProvider
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
    	...
    	{
    	case 0: this.itemIcon = par1IconRegister.registerIcon("dayz:camohelmet"); return;
    	case 1: this.itemIcon = par1IconRegister.registerIcon("dayz:camobody"); return;
    	case 2: this.itemIcon = par1IconRegister.registerIcon("dayz:camopants"); return;
    	case 3: this.itemIcon = par1IconRegister.registerIcon("dayz:camoboots"); return;
    	}
    }
