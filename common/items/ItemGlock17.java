...
public class ItemGlock17 extends Item
{
    ...
    public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityPlayer entityplayer, int i)
    {
        ...
        else if (itemstack.getItemDamage() >= 17 && entityplayer.inventory.hasItem(DayZ.glock17ammo.shiftedIndex))
        {
            ...
            if (f1 >= 1.0F)
            {
                ...
                entityplayer.inventory.consumeInventoryItem(DayZ.glock17ammo.shiftedIndex);
            }
        }
        else
        {
