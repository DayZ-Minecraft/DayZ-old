...
public class ComponentVillageHouse1DayZ extends ComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 7, 1, 1, ChestGenHooks.getItems(VILLAGE_BLACKSMITH), ChestGenHooks.getCount(VILLAGE_BLACKSMITH, par2Random));
