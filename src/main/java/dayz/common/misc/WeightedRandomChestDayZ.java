...
public class WeightedRandomChestDayZ extends WeightedRandomItem
{
     ...
     */
    public static void generateChestContents(Random par0Random, TileEntityChest par2TileEntityChest, int par3)
    {
        WeightedRandomChestDayZ[] par1ArrayOfWeightedRandomChestContent;
        par1ArrayOfWeightedRandomChestContent = ChestHookRegistry.loot;
