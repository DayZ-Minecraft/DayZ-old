...
public class CommonProxy
{
    ...
    public static void load(FMLInitializationEvent event)
    {
        ...
        DayZ.dayzChest = new BlockChestDayZ(DayZ.dayzChestID, 0).setUnlocalizedName("dayzchest");
        ...
        GameRegistry.registerBlock(DayZ.dayzChest, "dayzchest");
        ...
        LanguageRegistry.addName(DayZ.dayzChest, "Day Z Chest");
        ...
        { new ItemStack(DayZ.baseballbat, 1), new ItemStack(DayZ.nails, 1, 0) });

        GameRegistry.addShapelessRecipe(new ItemStack(DayZ.planknailed, 1), new Object[]
        { new ItemStack(DayZ.plank, 1), new ItemStack(DayZ.nails, 1, 0) });
        ...
        DamageType.bleedOut.registerDeathMessage();
        DamageType.zombieInfection.registerDeathMessage();
        DamageType.thirstDeath.registerDeathMessage();
    }
