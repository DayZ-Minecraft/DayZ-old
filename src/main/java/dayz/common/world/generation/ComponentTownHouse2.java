...
public class ComponentTownHouse2 extends ComponentVillage
{
    private int averageGroundLevel = -1;
    private boolean hasMadeChest;

    public ComponentTownHouse2(ComponentVillageStartPiece startPiece, int componentType, Random rand, StructureBoundingBox boundingBox, int coordBaseMode)
    {
