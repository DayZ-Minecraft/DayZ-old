...
public class WorldGenHouse extends WorldGenerator
{
    ...
    public boolean generate(World world, Random rand, int i, int j, int k)
    {
        ...
        boolean flag2 = false;
        int doorstate = 0;
        world.setBlockMetadataWithNotify(i + 1, j + 1, k + 5, Block.doorWood.blockID, doorstate);
        world.setBlockMetadataWithNotify(i + 1, j + 2, k + 5, Block.doorWood.blockID, 8 | (flag2 ? 1 : doorstate));
        ...
        world.setBlock(i + 8, j + 1, k + 5, chest);
        TileEntity tileentitychest = world.getBlockTileEntity(i + 8, j + 1, k + 5);
        if (tileentitychest != null)
        {
            WeightedRandomChestDayZ.generateChestContents(rand, (TileEntityChest) tileentitychest, rand.nextInt(5) + 1);
        }
        ChatHandler.logDebug("Day Z House Chest Created At " + (i + 8) + ", " + (j + 1) + ", " + (k + 5) + ".");
        ...
        world.setBlock(i + 5, j + 2, k + 10, 50);
        world.setBlock(i + 5, j + 2, k + 9, 5);
        world.setBlock(i + 5, j + 2, k + 8, 50);
        ...
        world.setBlock(i + 5, j + 2, k + 2, 50);
        world.setBlock(i + 5, j + 2, k + 1, 5);
        world.setBlock(i + 5, j + 2, k + 0, 50);
        ...
        world.setBlock(i + 10, j + 2, k + 5, 50);
        ...
        world.setBlock(i + 2, j + 3, k + 7, 50);
        world.setBlock(i + 2, j + 3, k + 6, 0);
        world.setBlock(i + 2, j + 3, k + 5, 0);
        world.setBlock(i + 2, j + 3, k + 4, 50);
        ...
        world.setBlock(i + 8, j + 3, k + 7, 50);
        world.setBlock(i + 8, j + 3, k + 6, 0);
        world.setBlock(i + 8, j + 3, k + 5, 0);
        world.setBlock(i + 8, j + 3, k + 4, 50);
