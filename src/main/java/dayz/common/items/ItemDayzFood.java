...
public class ItemDayzFood extends ItemFood
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            case 0:
                itemIcon = par1IconRegister.registerIcon("dayz:can2");
                return;
            case 1:
                itemIcon = par1IconRegister.registerIcon("dayz:can4");
                return;
            case 2:
                itemIcon = par1IconRegister.registerIcon("dayz:can1");
                return;
            case 3:
                itemIcon = par1IconRegister.registerIcon("dayz:sardines");
                return;
            case 4:
                itemIcon = par1IconRegister.registerIcon("dayz:chocolatebar");
                return;
            case 5:
                itemIcon = par1IconRegister.registerIcon("dayz:can5");
                return;
        }
    }
}